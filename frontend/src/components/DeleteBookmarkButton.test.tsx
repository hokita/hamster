...
describe('DeleteBookmarkButton', () => {
  it('does not delete on the first click — it asks first', () => {
    ...
    render(<DeleteBookmarkButton label="Example Site" onDelete={onDelete} />)
  ...
  it('shows a busy indicator instead of the button while the delete is in flight', () => {
    render(<DeleteBookmarkButton label="Example Site" onDelete={vi.fn()} isDeleting />)
  ...
  it('shows the word Delete in the labeled variant', () => {
    render(<DeleteBookmarkButton label="Example Site" onDelete={vi.fn()} variant="labeled" />)
